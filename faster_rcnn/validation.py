...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='D:/PycharmProjects/Detection-test/', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights', default='D:/PycharmProjects/Detection-test/fasterrcnn_voc2012.pth', type=str, help='training weights')
