...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='E:\\Users\\lenovo\\PycharmProjects\\Algorithm-test-index\\VOCdevkit', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights', default='E:\\Users\\lenovo\\PycharmProjects\\Algorithm-test-index\\fasterrcnn_voc2012.pth', type=str, help='training weights')
